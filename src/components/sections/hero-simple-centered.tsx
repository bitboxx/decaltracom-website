      ...
      <Container className={clsx('relative z-10 flex flex-col items-center gap-6', backgroundImageSrc && 'sm:gap-8')}>
        <div
          className={clsx(
            ...
            backgroundImageSrc &&
              'w-full rounded-[2rem] border border-white/70 bg-white/58 px-6 py-10 text-center shadow-[0_32px_90px_-48px_rgba(15,23,42,0.75)] backdrop-blur-md sm:px-10 sm:py-12',
          )}
        >
          {eyebrow}
