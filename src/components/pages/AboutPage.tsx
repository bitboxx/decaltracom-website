...
const storySections: StorySection[] = [
  ...
  },
  {
    step: '05',
    eyebrow: 'Purpose',
    title: 'Strengthening how capital is provided',
    icon: LightBulbIcon,
    pictureClassName:
        ...
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-10 px-6 md:max-w-3xl lg:max-w-7xl lg:px-10">
          <div className="flex max-w-5xl flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <h1 className="font-display text-4xl/11 font-medium tracking-tight text-mist-950 sm:text-5xl/14 lg:whitespace-nowrap">
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-start">
                ...
                {storySections.map((section, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex w-full items-end overflow-hidden rounded-[1.75rem] border p-4 text-left transition duration-300 ${
                        isActive
                    ...
                    >
                      ...
                      <div className={`absolute left-4 top-4 h-14 w-14 rounded-3xl ${section.accentClassName}`} />
                      <div className="relative flex w-full items-end justify-between gap-4">
                        <div className="max-w-[17rem]">
                          <p className="text-sm/6 font-semibold uppercase tracking-[0.16em] text-white/70">
                            {section.eyebrow}
                          </p>
                          <h2 className="mt-2 font-display text-xl/7 font-medium tracking-tight text-white">
                            {section.title}
                          </h2>
                        </div>
                        <div className="mb-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-white/15 bg-white/10 text-white">
            ...
            <article className="rounded-[2rem] border border-mist-200 bg-white p-6 shadow-sm sm:p-8">
              <div className="flex items-start justify-between gap-4 border-b border-mist-200 pb-6">
                <div className="space-y-2">
                  <p className="text-sm/6 font-semibold uppercase tracking-[0.16em] text-mist-500">
                    {activeSection.eyebrow}
                  </p>
                  <h2 className="font-display text-3xl/9 font-medium tracking-tight text-mist-950">
                    {activeSection.title}
                  </h2>
                </div>
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-[1.75rem] border border-mist-200 bg-white p-6 shadow-sm">
            <div className="flex h-14 w-14 items-center justify-center rounded-3xl border border-mist-200 bg-mist-100 font-display text-lg font-medium text-mist-700">
              MB
            </div>
            <h3 className="mt-5 font-display text-2xl/8 font-medium tracking-tight text-mist-950">Michael Bolle</h3>
          ...
          <article className="rounded-[1.75rem] border border-mist-200 bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-5 font-display text-2xl/8 font-medium tracking-tight text-mist-950">
